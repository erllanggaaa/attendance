...
<head>
    ...
    <meta charset="UTF-8">
<title>ATTENDANCE APP - PEGAWAI</title>
...
<!-- JavaScript Tambahan Close Button -->

 <script src="../demo/monarch/assets/js/3.2.1.jquery.min.js"></script>
 <script src="../demo/monarch/assets/js/popper.min.js"></script>
 <script src="../demo/monarch/assets/js/bt.min.js"></script>
...
<script type="text/javascript" src="../demo/monarch/assets/widgets/wow/wow.js"></script>
<script type="text/javascript">
    /* WOW animations */
...
<div class="center-vertical">
    ...
    <form action="include/user.php" class="center-margin" method="POST">
    ...
    if(isset($_GET['pesan'])){
        if($_GET['pesan'] == "gagal"){
            ...
            <div class='alert-content'><p align='center'><button type='button' class='close' data-dismiss='alert'>&times;</button><strong>Email Atau Password Salah!</strong></p></div></div>";
        }else if($_GET['pesan'] == "masuk-dulu"){
            echo "<div class='alert alert-warning'><p align='center'><button type='button' class='close' data-dismiss='alert'>&times;</button><strong>Anda Harus Login Terlebih Dahulu!</strong></p></div>";
        }else if($_GET['pesan'] == "logout"){
            echo "<div class='alert alert-warning'><p align='center'><button type='button' class='close' data-dismiss='alert'>&times;</button><strong>Anda Telah Berhasil Logout!</strong></p></div>";
        }
    }
    ?>
        ...
        <a href="/attendance-app"><h3 class="text-center pad25B font-white text-transform-upr font-size-23">Kembali ke Home</h3></a>
